...
#         # Try reader-provided APIs first
#         if hasattr(self.reader, "count_frames"):
#             try:
#                 return self.reader.count_frames()
#             except Exception:
#                 pass
#         if hasattr(self.reader, "get_length"):
#             try:
#                 return int(self.reader.get_length())
#             except Exception:
#                 pass
#         # Some readers expose nframes in metadata (e.g., images/GIF)
#         try:
...
#         except Exception:
#             pass
#         # Fallback: assume single-frame (common for static images)
#         return 1
...
class VideoData:
    ...
    def shape(self):
        if self.height is not None and self.width is not None:
            ...
            if isinstance(self.__getitem__(0), Image.Image):
